...
\begin{document}
  ...
  임복희 교수님께서 담당하시는 2021년 1학기 현대대수1및실습 1 분반 안의, N\"other 조의 이름으로 작성된 노트 정리입니다.
  ...
  물론 이 사실을 증명해야 봐야지 \textbf{mathematician}이겠죠?

  이때 ``$*$은 $S^1$ 위에서 복소수 곱셈의 \underline{유도된 연산}(\textit{induced operation})이다''라고 하는데,
  ...
  이러한 경우 $S'$가 \underline{$*$에 대하여 닫혀 있다}(\textit{closed under $*$})고 합니다.
  즉, $S'$가 $*$에 대하여 닫혀 있을 필요충분조건은
